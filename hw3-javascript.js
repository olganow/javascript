// Задание 1: Написать функцию, которая найдет и выведет в консоль юзеров, зарегистрированных 09.10.2021 и 10.10.2021). Массив в task1.txt
...
result.forEach(function (elem) {if (elem.registrationDate == '09.10.2021'||elem.registrationDate == '10.10.2021') console.log(elem) });
...
let fileContent = fs.readFileSync('task2.json');//файл в каталоге проекта

let people = JSON.parse(fileContent); 
console.log(people); 


//Task 3**1. Вывести все предприятия и их отделы. Рядом указать количество сотрудников. Для предприятия посчитать сумму всех сотрудников во всех отделах.
...
const enterprises = [
  ...
  for (var i = 0; i < enterprises.length; i ++) {
    ...
    //result.forEach(function (elem) {if (employees_count > 0) console.log(employees_count += employees_count ) });
